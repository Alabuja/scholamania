            ...
            <div class="col-lg-7">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <form role="form" action="{{ url('admin/individual/resources') }}" method="POST" enctype="multipart/form-data">
                            ...
                            {{-- <div class="box-body"> --}}
                                ...
                                <div class="col-xs-6">
                                    <button type="submit" class="btn btn-primary btn-block btn-flat">Add Resources (Individuals)</button>
                                </div>
                        </form>
                        </div>
