  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 page-content">
        ...
        <p></p>
        <div class="page_nav"><span>You are here:</span> <a href="{{ url('individual/home')}}">Home</a> <span><i class="fa fa-angle-double-right"></i>Club Activities</span></div>
      </div>
    </div>
  </div>
</section>
...
<div class="container">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <form class="form-horizontal" role="form" method="POST" action="{{ url('individual/assignment') }}" enctype="multipart/form-data">
                {{ csrf_field() }}

                <div class="form-group{{ $errors->has('assignment_submitted') ? ' has-error' : '' }} required">
