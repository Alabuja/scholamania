        ...
        <div class="container"> 
          ...
          <div class="collapse navbar-collapse" id="navbar-menu">
            <ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOut">
                ...
                <li><a href="{{ url('/individual/home') }}">Home</a></li>
                ...
                @else
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li class="{{ Request::is('individual/home') ? 'active' : '' }}">
                                <a href="{{ url('individual/home') }}">Home</a>
                            </li>
                            {{-- <li class="{{ Request::is('forums') ? 'active' : '' }}">
                                <a href="{{ url('forums') }}">Forum</a>
                            </li> --}}
                            <li class="{{ Request::is('individual/resource') ? 'active' : '' }}">
                                <a href="{{ url('individual/resource') }}">Resources</a>
                            </li>
                            {{-- <li class="{{ Request::is('coach') ? 'active' : '' }}">
                                <a href="{{ url('coach') }}">Add Coaches</a>
                            </li> --}}
                            <li class="{{ Request::is('individual/assignment') ? 'active' : '' }}">
                                <a href="{{ url('individual/assignment') }}">Club Activities</a>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">{{ Auth::guard('individual')->user()->username }}</a>

                        <ul class="dropdown-menu">
                            <li>
                                <a href="{{ url('individual/profile') }}"><i class="fa fa-btn fa-user"></i>Update Profile</a>
                            </li>
                            <li>
                                <a href="{{ url('individual/update')}}">Change password</a>
                            </li>
                            <li>
