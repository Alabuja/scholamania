  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 page-content">
        <h1>RESOURCES</h1>
        <p></p>
        <div class="page_nav"><span>You are here:</span> <a href="{{ url('individual/home')}}">Home</a> <span><i class="fa fa-angle-double-right"></i>Resources</span></div>
      </div>
    </div>
  </div>
</section>
	            ...
	            <table id="example2" class="table table-bordered table-striped">
	                ...
	                <tbody>
	                   @foreach($resources as $resource)
	                        <tr>
	                            <td>{{$resource->name}}</td>
	                            <td><a href="{{$resource->resource_url}}" download="{{$resource->resource_url}}">
