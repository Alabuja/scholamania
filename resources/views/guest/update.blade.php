  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 page-content">
        ...
        <p></p>
        <div class="page_nav"><span>You are here:</span> <a href="{{ url('individual/home')}}">Home</a> <span><i class="fa fa-angle-double-right"></i>Change Password</span></div>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <form class="form-horizontal" role="form" method="POST" action="{{ url('individual/update') }}">
                    {{ csrf_field() }}
